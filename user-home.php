  ...
  <body>
     ...
     <div class="logo"><img src="images/logo.png" alt="Picture"></div>
       <ul>
         ...
         <li><a href="checkout.php"><img src="images/cart-icon.png" id="cart-icon" alt="Cart Icon"></a><span id="cart-item"></span></li>
       </ul>
     </div>
        ...
        <div class="content">
          ...
          <a href="signout.php"><button class="shop-btn" type="button">Log Out</button></a>
        </div>
    </div>
   ...
   <!-- Category selection -->
    <?php  
      ...
      if ($categoryResult) {
         ...
         <div id="categories">
            <center>
                  <h1><br>CATEGORIES</h1><br>
                  <form action="user-category.php" method="post">
